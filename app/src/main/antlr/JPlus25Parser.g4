...
parser grammar JPlus25Parser;

options {
    tokenVocab = JPlus25Lexer;
}
...
enhancedForStatement
    : 'for' '(' enhancedForDeclaration ':' expression ')' statement
    ;

enhancedForStatementNoShortIf
    : 'for' '(' enhancedForDeclaration ':' expression ')' statementNoShortIf
    ;
